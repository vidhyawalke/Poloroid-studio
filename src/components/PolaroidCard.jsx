    ...
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <div
          ...
          onWheel={handleWheel}
          className="relative w-[300px] h-[300px] bg-[#fcfcfa] border border-stone-200/40 overflow-hidden flex items-center justify-center cursor-pointer rounded-[1px] select-none"
        >
          {image ? (
            <div
